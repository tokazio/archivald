...
import fr.tokazio.konsistksp.konsist.KonsistKspKoAssertionFailedException
...
class RuleValidator(
    ...
    private val classpathRuleFinder = ClasspathRuleFinder(
        logger = logger,
        classpath = options["konsistKspClasspath"]?.split(":") ?: emptyList(),
    )

    private val srcRuleFinder = SrcRuleFinder(
        logger = logger,
