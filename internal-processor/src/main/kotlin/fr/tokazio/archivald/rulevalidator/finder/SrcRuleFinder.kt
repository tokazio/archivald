...
import fr.tokazio.archivald.internal.collector.CollectorEngine
import fr.tokazio.archivald.internal.kotlin.FileClassLoader
    ...
    override fun find(): Set<String> {
        ...
        val ruleSrcFiles =
            CollectorEngine(logger)
                ...
                .toSet()
        logger.debug("Found ${ruleSrcFiles.size} files to compile from $srcInFolder")
        return try {
