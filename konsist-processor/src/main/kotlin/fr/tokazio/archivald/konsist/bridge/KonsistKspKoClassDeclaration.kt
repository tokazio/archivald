...
import fr.tokazio.archivald.internal.model.PropertyDeclaration
import fr.tokazio.archivald.konsist.bridge.provider.*
...
class KonsistKspKoClassDeclaration(
    ...
    override val packagee: KoPackageDeclaration =
        KonsistKspKoPackageDeclaration(logger, classDeclaration)
